...
if __name__ == '__main__':
    c = ConvPoolLayer(image_shape=(10, 1, 28, 28),
                  filter_shape=(20, 1, 5, 5),
                  poolsize=(2, 2))
    c1 = ConvPoolLayer(image_shape=(10, 20, 12, 12),
                  filter_shape=(40, 20, 5, 5),
                  poolsize=(2, 2))
    f = FullyConnectedLayer(n_in=40*4*4, n_out=100)
    s = SoftmaxLayer(n_in=100, n_out=10)
    net = Network([c,c1, f, s], mini_batch_size=10)
